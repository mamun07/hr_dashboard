                ...
                <Card variant="outlined" sx={{p: '15px'}}>
                    ...
                    <Grid container spacing={2} pb={2}>
                        <Grid item xs={12} md={6}>
                            <Card variant="outlined" sx={{ textAlign: 'center' ,padding: '10px', marginBottom: '15px'}}>
                    ...
                    <Box variant='dev'>
                        <Box mb={2} sx={{display: 'flex', alignItems: 'center', justifyContent: 'space-between'}}>
                            <Typography display={'flex'} alignItems={'center'} variant='span'>
                                <CircularProgress size={20} sx={{marginRight: '10px'}} color="success" variant="determinate" value={80}/>
                                Completed Tasks
                            </Typography>
                        ...
                        <Box mb={2} display={'flex'} alignItems={'center'} justifyContent={'space-between'}>
                            <Typography display={'flex'} alignItems={'center'} variant='span'>
                                <CircularProgress size={20} sx={{marginRight: '10px'}} color="error" variant="determinate" value={78}/>
                                Inprogress Tasks
                            </Typography>
                            <Typography variant='span'>
                                342
                        ...
                        <Box mb={2} display={'flex'} alignItems={'center'} justifyContent={'space-between'}>
                            <Typography display={'flex'} alignItems={'center'} variant='span'>
                                <CircularProgress size={20} sx={{marginRight: '10px'}} color='info' variant="determinate" value={95}/>
                                On Hold Tasks
                            </Typography>
                            <Typography variant='span'>
                                34
                        ...
                        <Box mb={2} display={'flex'} alignItems={'center'} justifyContent={'space-between'}>
                            <Typography display={'flex'} alignItems={'center'} variant='span'>
                                <CircularProgress size={20} sx={{marginRight: '10px'}} color="secondary" variant="determinate" value={78}/>
                                Pending Tasks
                            </Typography>
                            <Typography variant='span'>
                                23
                        ...
                        <Box display={'flex'} alignItems={'center'} justifyContent={'space-between'}>
                            <Typography display={'flex'} alignItems={'center'} variant='span'>
                                <CircularProgress size={20} sx={{marginRight: '10px'}} color="secondary" variant="determinate" value={89}/>
                                Pending Tasks
                            </Typography>
                            <Typography variant='span'>
                                23
